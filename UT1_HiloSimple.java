...
public class UT1_HiloSimple {
    ...
    static class HiloExtendido extends Thread {
        ...
        @Override
        public void run() {
            for (int i = 1; i <= 5; i++) { // 🔄 Bucle que se repite 10 veces
                System.out.println("[" + nombreHilo + "] Ejecutando paso " + i); // 🖨️ Imprime paso actual
                try {
                    Thread.sleep(2000); // 💤 Espera 1 segundo entre pasos
    ...
    public static void main(String[] args) {
        ...
        hilo1.start();
        hilo2.start(); // ▶️ Arranca ejecución de hilo1
      // ▶️ Arranca ejecución de hilo2
        ...
        for (int j = 1; j <= 5; j++) {
            ...
            try {
                ...
                Thread.sleep(1000); // 💤 Pausa entre tareas
            } catch (InterruptedException e) {
